  ...
  return (
    <div className="page">
      <div className="page__container">
        ...
        <Footer />
        <PopupWithForm className="edit" title="Редактировать профиль" isOpen={isEditProfilePopupOpen} onClose={closeAllPopup}>
        ...
        <PopupWithForm className="add" title="Новое место" isOpen={isAddPlacePopupOpen} onClose={closeAllPopup}>
        ...
        <PopupWithForm className="avatar" title="Обновить аватар" isOpen={isEditAvatarPopupOpen} onClose={closeAllPopup}>
